 ...
 * PATCH /empreses/:id
 */
export async function updateEmpresa(id: number, payload: Partial<{ nom: string; ubicacio: string; capacitat: number | null; descripcio: string; colorPrimari: string }>): Promise<AuthUser['empresa']> {
